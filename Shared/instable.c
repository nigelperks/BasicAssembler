...
//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  ...
  { TOK_CALL,    OF_FAR,   OF_NONE,  1, NOPR, 0x9A, 0x00, 0,  RMN, 0,  4,  0,   P86 },
...
//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  ...
  { TOK_FADD,    OF_STT,   OF_STI,   1, WAIT, 0xD8, 0x00, 0,  SSI, 0,  0,  0,   P87 },
  { TOK_FADD,    OF_STI,   OF_STT,   1, WAIT, 0xDC, 0x00, 0,  SIS, 0,  0,  0,   P87 },
  { TOK_FADD,    OF_STT,   OF_STT,   1, WAIT, 0xD8, 0x00, 0,  SSC, 0,  0,  0,   P87 },
  { TOK_FADD,    OF_MEM32, OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  MMC, 0,  0,  0,   P87 },
  { TOK_FADD,    OF_MEM64, OF_NONE,  1, WAIT, 0xDC, 0x00, 0,  MMC, 0,  0,  0,   P87 },

  { TOK_FADDP,   OF_STI,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SIS, 0,  0,  0,   P87 },
  { TOK_FADDP,   OF_STT,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SSC, 0,  0,  0,   P87 },
  { TOK_FADDP,   OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 0,  0,  0,   P87 },

//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  { TOK_FBLD,    OF_MEM80, OF_NONE,  1, WAIT, 0xDF, 0x00, 0,  MMC, 4,  0,  0,   P87 },
  { TOK_FBSTP,   OF_MEM80, OF_NONE,  1, WAIT, 0xDF, 0x00, 0,  MMC, 6,  0,  0,   P87 },
  ...
  { TOK_FCOM,    OF_STT,   OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  STC, 2,  0,  0,   P87 },
  { TOK_FCOM,    OF_NONE,  OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  STK, 2,  0,  0,   P87 },
  { TOK_FCOM,    OF_MEM32, OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  MMC, 2,  0,  0,   P87 },
  { TOK_FCOM,    OF_MEM64, OF_NONE,  1, WAIT, 0xDC, 0x00, 0,  MMC, 2,  0,  0,   P87 },

  { TOK_FCOMP,   OF_STI,   OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  SIC, 3,  0,  0,   P87 },
  { TOK_FCOMP,   OF_STT,   OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  STC, 3,  0,  0,   P87 },
  { TOK_FCOMP,   OF_MEM32, OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  MMC, 3,  0,  0,   P87 },
  { TOK_FCOMP,   OF_MEM64, OF_NONE,  1, WAIT, 0xDC, 0x00, 0,  MMC, 3,  0,  0,   P87 },
  { TOK_FCOMP,   OF_NONE,  OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  STK, 3,  0,  0,   P87 },

  { TOK_FCOMPP,  OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 3,  0,  0,   P87 },
...
//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  { TOK_FDIV,    OF_STT,   OF_STI,   1, WAIT, 0xD8, 0x00, 0,  SSI, 6,  0,  0,   P87 },
  { TOK_FDIV,    OF_STI,   OF_STT,   1, WAIT, 0xDC, 0x00, 0,  SIS, 7,  0,  0,   P87 },
  { TOK_FDIV,    OF_STT,   OF_STT,   1, WAIT, 0xD8, 0x00, 0,  SSC, 6,  0,  0,   P87 },
  { TOK_FDIV,    OF_MEM32, OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  MMC, 6,  0,  0,   P87 },
  { TOK_FDIV,    OF_MEM64, OF_NONE,  1, WAIT, 0xDC, 0x00, 0,  MMC, 6,  0,  0,   P87 },
  { TOK_FDIVP,   OF_STI,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SIS, 7,  0,  0,   P87 },
  { TOK_FDIVP,   OF_STT,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SSC, 7,  0,  0,   P87 },
  { TOK_FDIV,    OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 7,  0,  0,   P87 },
  { TOK_FDIVP,   OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 7,  0,  0,   P87 },

  { TOK_FDIVR,   OF_STT,   OF_STI,   1, WAIT, 0xD8, 0x00, 0,  SSI, 7,  0,  0,   P87 },
  { TOK_FDIVR,   OF_STI,   OF_STT,   1, WAIT, 0xDC, 0x00, 0,  SIS, 6,  0,  0,   P87 },
  { TOK_FDIVR,   OF_STT,   OF_STT,   1, WAIT, 0xD8, 0x00, 0,  SSC, 7,  0,  0,   P87 },
  { TOK_FDIVR,   OF_MEM32, OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  MMC, 7,  0,  0,   P87 },
  { TOK_FDIVR,   OF_MEM64, OF_NONE,  1, WAIT, 0xDC, 0x00, 0,  MMC, 7,  0,  0,   P87 },
  { TOK_FDIVRP,  OF_STI,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SIS, 6,  0,  0,   P87 },
  { TOK_FDIVRP,  OF_STT,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SSC, 6,  0,  0,   P87 },
  { TOK_FDIVR,   OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 6,  0,  0,   P87 },
  { TOK_FDIVRP,  OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 6,  0,  0,   P87 },

//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  { TOK_FENI,    OF_NONE,  OF_NONE,  2, WAIT, 0xDB, 0xE0, 0,  RMN, 0,  0,  0,   P87 },
  { TOK_FNENI,   OF_NONE,  OF_NONE,  2, NOPR, 0xDB, 0xE0, 0,  RMN, 0,  0,  0,   P87 },

  { TOK_FFREE,   OF_STI,   OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  SIC, 0,  0,  0,   P87 },
  { TOK_FFREE,   OF_STT,   OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  STC, 0,  0,  0,   P87 },
  { TOK_FFREE,   OF_NONE,  OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  STK, 0,  0,  0,   P87 },

  { TOK_FIADD,   OF_MEM16, OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  MMC, 0,  0,  0,   P87 },
  { TOK_FIADD,   OF_MEM32, OF_NONE,  1, WAIT, 0xDA, 0x00, 0,  MMC, 0,  0,  0,   P87 },

  { TOK_FICOM,   OF_MEM16, OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  MMC, 2,  0,  0,   P87 },
  { TOK_FICOM,   OF_MEM32, OF_NONE,  1, WAIT, 0xDA, 0x00, 0,  MMC, 2,  0,  0,   P87 },

  { TOK_FICOMP,  OF_MEM16, OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  MMC, 3,  0,  0,   P87 },
  { TOK_FICOMP,  OF_MEM32, OF_NONE,  1, WAIT, 0xDA, 0x00, 0,  MMC, 3,  0,  0,   P87 },

  { TOK_FIDIV,   OF_MEM16, OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  MMC, 6,  0,  0,   P87 },
  { TOK_FIDIV,   OF_MEM32, OF_NONE,  1, WAIT, 0xDA, 0x00, 0,  MMC, 6,  0,  0,   P87 },

//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  { TOK_FIDIVR,  OF_MEM16, OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  MMC, 7,  0,  0,   P87 },
  { TOK_FIDIVR,  OF_MEM32, OF_NONE,  1, WAIT, 0xDA, 0x00, 0,  MMC, 7,  0,  0,   P87 },

  { TOK_FILD,    OF_MEM16, OF_NONE,  1, WAIT, 0xDF, 0x00, 0,  MMC, 0,  0,  0,   P87 },
  { TOK_FILD,    OF_MEM32, OF_NONE,  1, WAIT, 0xDB, 0x00, 0,  MMC, 0,  0,  0,   P87 },
  { TOK_FILD,    OF_MEM64, OF_NONE,  1, WAIT, 0xDF, 0x00, 0,  MMC, 5,  0,  0,   P87 },

  { TOK_FIMUL,   OF_MEM16, OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  MMC, 1,  0,  0,   P87 },
  { TOK_FIMUL,   OF_MEM32, OF_NONE,  1, WAIT, 0xDA, 0x00, 0,  MMC, 1,  0,  0,   P87 },
  ...
  { TOK_FIST,    OF_MEM16, OF_NONE,  1, WAIT, 0xDF, 0x00, 0,  MMC, 2,  0,  0,   P87 },
  { TOK_FIST,    OF_MEM32, OF_NONE,  1, WAIT, 0xDB, 0x00, 0,  MMC, 2,  0,  0,   P87 },
  { TOK_FISTP,   OF_MEM16, OF_NONE,  1, WAIT, 0xDF, 0x00, 0,  MMC, 3,  0,  0,   P87 },
  { TOK_FISTP,   OF_MEM32, OF_NONE,  1, WAIT, 0xDB, 0x00, 0,  MMC, 3,  0,  0,   P87 },
  { TOK_FISTP,   OF_MEM64, OF_NONE,  1, WAIT, 0xDF, 0x00, 0,  MMC, 7,  0,  0,   P87 },

//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  { TOK_FISUB,   OF_MEM16, OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  MMC, 4,  0,  0,   P87 },
  { TOK_FISUB,   OF_MEM32, OF_NONE,  1, WAIT, 0xDA, 0x00, 0,  MMC, 4,  0,  0,   P87 },

  { TOK_FISUBR,  OF_MEM16, OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  MMC, 5,  0,  0,   P87 },
  { TOK_FISUBR,  OF_MEM32, OF_NONE,  1, WAIT, 0xDA, 0x00, 0,  MMC, 5,  0,  0,   P87 },

  { TOK_FLD,     OF_MEM32, OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  MMC, 0,  0,  0,   P87 },
  { TOK_FLD,     OF_MEM64, OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  MMC, 0,  0,  0,   P87 },
  { TOK_FLD,     OF_MEM80, OF_NONE,  1, WAIT, 0xDB, 0x00, 0,  MMC, 5,  0,  0,   P87 },
  { TOK_FLD,     OF_STI,   OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  SIC, 0,  0,  0,   P87 },
  { TOK_FLD,     OF_STT,   OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  STC, 0,  0,  0,   P87 },
  { TOK_FLD,     OF_NONE,  OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  STK, 0,  0,  0,   P87 },

  { TOK_FLDCW,   OF_MEM16, OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  MMC, 5,  0,  0,   P87 },
  { TOK_FLDENV,  OF_MEM,   OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  MMC, 4,  0,  0,   P87 },
...
//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  { TOK_FMUL,    OF_MEM32, OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  MMC, 1,  0,  0,   P87 },
  { TOK_FMUL,    OF_MEM64, OF_NONE,  1, WAIT, 0xDC, 0x00, 0,  MMC, 1,  0,  0,   P87 },
  { TOK_FMUL,    OF_STT,   OF_STI,   1, WAIT, 0xD8, 0x00, 0,  SSI, 1,  0,  0,   P87 },
  { TOK_FMUL,    OF_STT,   OF_STT,   1, WAIT, 0xD8, 0x00, 0,  SSC, 1,  0,  0,   P87 },
  { TOK_FMUL,    OF_STI,   OF_STT,   1, WAIT, 0xDC, 0x00, 0,  SIS, 1,  0,  0,   P87 },
  { TOK_FMULP,   OF_STI,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SIS, 1,  0,  0,   P87 },
  { TOK_FMULP,   OF_STT,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SSC, 1,  0,  0,   P87 },
  { TOK_FMUL,    OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 1,  0,  0,   P87 },
  { TOK_FMULP,   OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 1,  0,  0,   P87 },
  ...
  { TOK_FRSTOR,  OF_MEM,   OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  MMC, 4,  0,  0,   P87 },
  { TOK_FSAVE,   OF_MEM,   OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  MMC, 6,  0,  0,   P87 },
  { TOK_FNSAVE,  OF_MEM,   OF_NONE,  1, NOPR, 0xDD, 0x00, 0,  MMC, 6,  0,  0,   P87 },

//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  { TOK_FSCALE,  OF_NONE,  OF_NONE,  2, WAIT, 0xD9, 0xFD, 0,  RMN, 0,  0,  0,   P87 },
  { TOK_FSQRT,   OF_NONE,  OF_NONE,  2, WAIT, 0xD9, 0xFA, 0,  RMN, 0,  0,  0,   P87 },

  { TOK_FST,     OF_MEM32, OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  MMC, 2,  0,  0,   P87 },
  { TOK_FST,     OF_MEM64, OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  MMC, 2,  0,  0,   P87 },
  { TOK_FST,     OF_STI,   OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  SIC, 2,  0,  0,   P87 },
  { TOK_FST,     OF_STT,   OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  STC, 2,  0,  0,   P87 },
  { TOK_FSTP,    OF_MEM32, OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  MMC, 3,  0,  0,   P87 },
  { TOK_FSTP,    OF_MEM64, OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  MMC, 3,  0,  0,   P87 },
  { TOK_FSTP,    OF_MEM80, OF_NONE,  1, WAIT, 0xDB, 0x00, 0,  MMC, 7,  0,  0,   P87 },
  { TOK_FSTP,    OF_STI,   OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  SIC, 3,  0,  0,   P87 },
  { TOK_FSTP,    OF_STT,   OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  STC, 3,  0,  0,   P87 },
  { TOK_FST,     OF_NONE,  OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  STK, 2,  0,  0,   P87 },
  { TOK_FSTP,    OF_NONE,  OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  STK, 3,  0,  0,   P87 },

  { TOK_FSTCW,   OF_MEM16, OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  MMC, 7,  0,  0,   P87 },
  { TOK_FNSTCW,  OF_MEM16, OF_NONE,  1, NOPR, 0xD9, 0x00, 0,  MMC, 7,  0,  0,   P87 },

  { TOK_FSTENV,  OF_MEM,   OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  MMC, 6,  0,  0,   P87 },
  { TOK_FNSTENV, OF_MEM,   OF_NONE,  1, NOPR, 0xD9, 0x00, 0,  MMC, 6,  0,  0,   P87 },

//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  { TOK_FSTSW,   OF_MEM16, OF_NONE,  1, WAIT, 0xDD, 0x00, 0,  MMC, 7,  0,  0,   P87 },
  { TOK_FNSTSW,  OF_MEM16, OF_NONE,  1, NOPR, 0xDD, 0x00, 0,  MMC, 7,  0,  0,   P87 },

  { TOK_FSUB,    OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 5,  0,  0,   P87 },
  { TOK_FSUB,    OF_STT,   OF_STI,   1, WAIT, 0xD8, 0x00, 0,  SSI, 4,  0,  0,   P87 },
  { TOK_FSUB,    OF_STI,   OF_STT,   1, WAIT, 0xDC, 0x00, 0,  SIS, 5,  0,  0,   P87 },
  { TOK_FSUB,    OF_STT,   OF_STT,   1, WAIT, 0xD8, 0x00, 0,  SSC, 4,  0,  0,   P87 },
  { TOK_FSUB,    OF_MEM32, OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  MMC, 4,  0,  0,   P87 },
  { TOK_FSUB,    OF_MEM64, OF_NONE,  1, WAIT, 0xDC, 0x00, 0,  MMC, 4,  0,  0,   P87 },
  { TOK_FSUBP,   OF_STI,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SIS, 5,  0,  0,   P87 },
  { TOK_FSUBP,   OF_STT,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SSC, 5,  0,  0,   P87 },
  { TOK_FSUBP,   OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 5,  0,  0,   P87 },

  { TOK_FSUBR,   OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 4,  0,  0,   P87 },
  { TOK_FSUBR,   OF_STT,   OF_STI,   1, WAIT, 0xD8, 0x00, 0,  SSI, 5,  0,  0,   P87 },
  { TOK_FSUBR,   OF_STI,   OF_STT,   1, WAIT, 0xDC, 0x00, 0,  SIS, 4,  0,  0,   P87 },
  { TOK_FSUBR,   OF_STT,   OF_STT,   1, WAIT, 0xD8, 0x00, 0,  SSC, 5,  0,  0,   P87 },
  { TOK_FSUBR,   OF_MEM32, OF_NONE,  1, WAIT, 0xD8, 0x00, 0,  MMC, 5,  0,  0,   P87 },
  { TOK_FSUBR,   OF_MEM64, OF_NONE,  1, WAIT, 0xDC, 0x00, 0,  MMC, 5,  0,  0,   P87 },
  { TOK_FSUBRP,  OF_STI,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SIS, 4,  0,  0,   P87 },
  { TOK_FSUBRP,  OF_STT,   OF_STT,   1, WAIT, 0xDE, 0x00, 0,  SSC, 4,  0,  0,   P87 },
  { TOK_FSUBRP,  OF_NONE,  OF_NONE,  1, WAIT, 0xDE, 0x00, 0,  STK, 4,  0,  0,   P87 },
...
//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  ...
  { TOK_FXCH,    OF_STI,   OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  SIC, 1,  0,  0,   P87 },
  { TOK_FXCH,    OF_STT,   OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  STC, 1,  0,  0,   P87 },
  { TOK_FXCH,    OF_NONE,  OF_NONE,  1, WAIT, 0xD9, 0x00, 0,  STK, 1,  0,  0,   P87 },

  { TOK_FXTRACT, OF_NONE,  OF_NONE,  2, WAIT, 0xD9, 0xF4, 0,  RMN, 0,  0,  0,   P87 },
  { TOK_FYL2X,   OF_NONE,  OF_NONE,  2, WAIT, 0xD9, 0xF1, 0,  RMN, 0,  0,  0,   P87 },
...
//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  ...
  { TOK_INT,     OF_IMM,   OF_NONE,  1, NOPR, 0xCD, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  ...
  { TOK_JMP,     OF_FAR,   OF_NONE,  1, NOPR, 0xEA, 0x00, 0,  RMN, 0,  4,  0,   P86 },

//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  { TOK_JA,      OF_JUMP,  OF_NONE,  1, NOPR, 0x77, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JAE,     OF_JUMP,  OF_NONE,  1, NOPR, 0x73, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JB,      OF_JUMP,  OF_NONE,  1, NOPR, 0x72, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JBE,     OF_JUMP,  OF_NONE,  1, NOPR, 0x76, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JC,      OF_JUMP,  OF_NONE,  1, NOPR, 0x72, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JCXZ,    OF_JUMP,  OF_NONE,  1, NOPR, 0xE3, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JE,      OF_JUMP,  OF_NONE,  1, NOPR, 0x74, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JG,      OF_JUMP,  OF_NONE,  1, NOPR, 0x7F, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JGE,     OF_JUMP,  OF_NONE,  1, NOPR, 0x7D, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JL,      OF_JUMP,  OF_NONE,  1, NOPR, 0x7C, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JLE,     OF_JUMP,  OF_NONE,  1, NOPR, 0x7E, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNA,     OF_JUMP,  OF_NONE,  1, NOPR, 0x76, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNAE,    OF_JUMP,  OF_NONE,  1, NOPR, 0x72, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNB,     OF_JUMP,  OF_NONE,  1, NOPR, 0x73, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNBE,    OF_JUMP,  OF_NONE,  1, NOPR, 0x77, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNC,     OF_JUMP,  OF_NONE,  1, NOPR, 0x73, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNE,     OF_JUMP,  OF_NONE,  1, NOPR, 0x75, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNG,     OF_JUMP,  OF_NONE,  1, NOPR, 0x7E, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNGE,    OF_JUMP,  OF_NONE,  1, NOPR, 0x7C, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNL,     OF_JUMP,  OF_NONE,  1, NOPR, 0x7D, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNLE,    OF_JUMP,  OF_NONE,  1, NOPR, 0x7F, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNO,     OF_JUMP,  OF_NONE,  1, NOPR, 0x71, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNP,     OF_JUMP,  OF_NONE,  1, NOPR, 0x7B, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNS,     OF_JUMP,  OF_NONE,  1, NOPR, 0x79, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JNZ,     OF_JUMP,  OF_NONE,  1, NOPR, 0x75, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JO,      OF_JUMP,  OF_NONE,  1, NOPR, 0x70, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JP,      OF_JUMP,  OF_NONE,  1, NOPR, 0x7A, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JPE,     OF_JUMP,  OF_NONE,  1, NOPR, 0x7A, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JPO,     OF_JUMP,  OF_NONE,  1, NOPR, 0x7B, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JS,      OF_JUMP,  OF_NONE,  1, NOPR, 0x78, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_JZ,      OF_JUMP,  OF_NONE,  1, NOPR, 0x74, 0x00, 0,  RMN, 0,  1,  0,   P86 },
...
//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  ...
  { TOK_LOOP,    OF_JUMP,  OF_NONE,  1, NOPR, 0xE2, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_LOOPE,   OF_JUMP,  OF_NONE,  1, NOPR, 0xE1, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_LOOPZ,   OF_JUMP,  OF_NONE,  1, NOPR, 0xE1, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_LOOPNE,  OF_JUMP,  OF_NONE,  1, NOPR, 0xE0, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_LOOPNZ,  OF_JUMP,  OF_NONE,  1, NOPR, 0xE0, 0x00, 0,  RMN, 0,  1,  0,   P86 },
...
//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  { TOK_OUT,     OF_IMM,   OF_AL,    1, NOPR, 0xE6, 0x00, 0,  RMN, 0,  1,  0,   P86 },
  { TOK_OUT,     OF_IMM,   OF_AX,    1, NOPR, 0xE7, 0x00, 0,  RMN, 0,  1,  0,   P86 },
...
//  instruc      oper1     oper2     opcodes             +opc R/M reg imm1 imm2 cpu
  ...
  { TOK_RET,     OF_IMM,   OF_NONE,  1, NOPR, 0xC2, 0x00, 0,  RMN, 0,  2,  0,   P86 },
  { TOK_RETN,    OF_NONE,  OF_NONE,  1, NOPR, 0xC3, 0x00, 0,  RMN, 0,  0,  0,   P86 },
  { TOK_RETN,    OF_IMM,   OF_NONE,  1, NOPR, 0xC2, 0x00, 0,  RMN, 0,  2,  0,   P86 },
  { TOK_RETF,    OF_NONE,  OF_NONE,  1, NOPR, 0xCB, 0x00, 0,  RMN, 0,  0,  0,   P86 },
  { TOK_RETF,    OF_IMM,   OF_NONE,  1, NOPR, 0xCA, 0x00, 0,  RMN, 0,  2,  0,   P86 },
